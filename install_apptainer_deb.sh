#!/bin/bash
_get_latest_release() { # From: https://gist.github.com/lukechilds/a83e1d7127b78fef38c2914c4ececc3c
...
if [[ -z $INSTALLED_VERSION ]]; then # No apptainer (INSTALLED_VERSION is empty)
    install_apptainer
