...
export function addGoalMarker(viewer, goalX, goalY) {
    ...
    if (currentGoalMarker) {
        viewer.scene.removeChild(currentGoalMarker);
    }
    ...
    currentGoalMarker = polygonMarker;
}
...
// export function updateMarkerInteraction(enable) {
//     if (currentGoalMarker) {
//         currentGoalMarker.mouseEnabled = enable;
//         currentGoalMarker.mouseChildren = enable;  // Assuming it has interactive children
//     }
// }
